 ...
 */
public class SortChoserDialogFragment extends DialogFragment {
    ...
    public SortChoserDialogFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sort_choser_dialog, container, false);
